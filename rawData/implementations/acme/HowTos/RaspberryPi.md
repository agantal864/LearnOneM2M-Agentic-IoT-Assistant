Source: https://acmecse.net/howtos/RaspberryPi/
...
The easiest way to install *pyenv* is to run the automatic installer as described [here](https://github.com/pyenv/pyenv#automatic-installer):
...
See also [How to Install pyenv](../HowTo-pyenv/) for further details.
...
One can now continue with the [installation and activation of a different Python version in the virtual environment](../HowTo-pyenv/) and the [installation of ACME itself](../../setup/Installation/).
...
You can now follow the instructions in the [Installation](../../setup/Installation/) guide to install the ACME CSE on your Raspberry Pi.