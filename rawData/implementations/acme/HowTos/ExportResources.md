Source: https://acmecse.net/howtos/ExportResources/
...
Similar to exporting other resources, content instances from <container> and <timeSeries> resources can be exported via the text UI as a CSV[1](#fn:1) file or copied as CSV data to the clipboard. This may be useful for backing up content or exporting data for further analysis.
...
1. Comma-separated values [↩](#fnref:1 "Jump back to footnote 1 in the text")