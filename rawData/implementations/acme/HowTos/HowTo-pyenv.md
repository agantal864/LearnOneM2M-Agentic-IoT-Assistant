Source: https://acmecse.net/howtos/HowTo-pyenv/

# How to Install pyenv

This guide shortly describes how to install the [pyenv](https://github.com/pyenv/pyenv) virtual environment manager.
In addition, we will install [pyenv-virtualenv](https://github.com/pyenv/pyenv-virtualenv). This is a *pyenv* plugin for creating and managing virtual Python environments.
...
This guide assumes that you have installed the [homebrew](https://brew.sh) package manager.
