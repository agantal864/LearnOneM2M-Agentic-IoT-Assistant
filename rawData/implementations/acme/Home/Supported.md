Source: https://acmecse.net/home/Supported/
...
:   The ACME CSE fully supports the FlexContainer resource type.
    ...
    It is possible to use the predefined FlexContainer Specializations of [oneM2M TS-0023](https://specifications.onem2m.org/ts-0023/latest), *AllJoin*, oneM2M's *GenericInterworking*, or to define custom FlexContainerSpecializations.

    See [Attribute Policies](../../development/AttributePolicies/) for further details.
...
:   The http protocol is supported, including TLS (https) and CORS support.
    ...
    See also the [allowPatchForDelete](../../setup/Configuration-http/#general-settings) configuration setting.
...
:   The WebSocket protocol is supported, including TLS (wss) support
    ...
    Besides the standard oneM2M WebSocket binding, the ACME CSE supports an [experimental extension](../../howtos/ExperimentalWebSocketBinding/) to better support notifications.
...
**CBOR**
:   CBOR is a [binary serialization](https://cbor.io) format.  
...
:   Using [PATCH requests](../../setup/Configuration-http/#general-settings) to emulate DELETE requests for http/1.0 clients.