Source: https://acmecse.net/development/Embedding_ACME/
...
You might want to get the example from the main file [acme/\_\_main\_\_.py](https://github.com/ankraft/ACME-oneM2M-CSE/tree/master/acme/__main__.py) where you could replace the line:

Replace this line from the main file
...
Call the CSE's startup function
...
Run the CSE in a Jupyter Notebook
