Source: https://acmecse.net/development/tools/NotificationServer/

# Notification Server

The Notification Server that is provided in the directory [tools/notificationServer](https://github.com/ankraft/ACME-oneM2M-CSE/blob/master/tools/notificationServer) is a simple implementation of a Notification Server that can be used to receive notifications from a CSE.
