Source: https://acmecse.net/development/tools/OnboardingTool/
...
| --zookeeper-host | Specify the Zookeeper host name. |
| --zookeeper-port | Specify the Zookeeper port (default: 2181). |
