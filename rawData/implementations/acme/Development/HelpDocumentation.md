Source: https://acmecse.net/development/HelpDocumentation/

# Help File Format

Some CSE UI components provide a markdown documentation to the user, such as the Text UI. That documentation is imported from the [init](https://github.com/ankraft/ACME-oneM2M-CSE/blob/master/acme/init) directory as well. The file extension for documentation files is `.docmd`.
