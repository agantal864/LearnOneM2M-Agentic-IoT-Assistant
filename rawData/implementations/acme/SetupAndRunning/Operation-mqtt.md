Source: https://acmecse.net/setup/Operation-mqtt/

# Operation - MQTT Broker

ACME supports Mca, Mcc and Mcc' communication via MQTT. This binding must be enabled in the configuration file with the [`[client.mqtt].enable`](../Configuration-mqtt/#general-settings) setting. The address and optionally the port of the MQTT broker must be configured as well.
...
MQTT WebSocket Configuration Example
