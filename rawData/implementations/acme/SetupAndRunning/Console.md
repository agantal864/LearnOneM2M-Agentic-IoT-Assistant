Source: https://acmecse.net/setup/Console/
...
In addition to the build-in commands, the console shows the [Script commands](../../development/ACMEScript/) with a configured [key binding](../../development/ACMEScript-metatags/#onkey).
