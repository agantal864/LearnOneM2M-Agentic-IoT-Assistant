Source: https://acmecse.net/setup/Configuration-ws/
...
| address | Own address. Should be a local/public reachable address. | ws://[${basic.config:cseHost}](../Configuration-basic/#basic-configuration):${port} |
| loglevel | Loglevel for the WebSocket server. Allowed values: `debug`, `info`, `warning`, `error`, `off`. | [${basic.config:logLevel}](../Configuration-logging/) |
| timeout | Timeout when sending websocket requests and waiting for responses. | [${cse:requestExpirationDelta}](../Configuration-cse/#general-settings) |
...
[WebSocket Authentication](../Certificates/#websocket-authentication)
