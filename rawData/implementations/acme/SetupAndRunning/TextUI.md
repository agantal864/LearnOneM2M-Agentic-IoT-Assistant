Source: https://acmecse.net/setup/TextUI/
...
The text UI is started automatically in some [configuration modes](../Installation/#guided-onboarding) when the CSE is started.
...
:   See the [ACMEScript meta-tags](../../development/ACMEScript-metatags/#tuitool) for more information.
